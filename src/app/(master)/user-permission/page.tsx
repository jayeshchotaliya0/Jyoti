        ...
        <>
            ...
            <div className="grid gap-4 grid-cols-2 mt-6">
                <div className="grid gap-6 grid-cols-2">
                    <div className="mb-2">
                        <span className="text-base mb-2 block">UserName</span>
                        <select className="block w-full h-12 px-4 bg-white text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option>USR-01205</option>
                            <option>USR-01206</option>
                            <option>USR-01207</option>
                            <option>USR-01208</option>
                            <option>USR-01209</option>
                        </select>
                    </div>
                    <div className="mb-2">
                        <span className="text-base mb-2 block">Module name</span>
                        <select className="block w-full h-12 px-4 bg-white text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
