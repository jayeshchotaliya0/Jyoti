interface TabArrayProps {
  ...
  const TabArray: TabArrayProps[] = [
    ...
    },
    {
      ...
      type: false,
      showTab: true,
      tab: ['Order Wise Planning', 'Cell Planning', 'Cell Load Analysis', 'Work Center Load Analysis', 'Sub. Assm. Wise']
    },
    {
      url: '/machine-shop-planning',
      type: false,
      showTab: true,
      tab: ['Pending', 'Running', 'Completed', 'Hold', 'Cell', 'Cell Load Analysis', 'Work Center Load Analysis', 'Queue', 'Unplanned PO']
    },
    {
